...
@section('content')
<!-- Hero Section Begin -->
<section class="hero set-bg" data-setbg="{{ asset('assets/img/hero-bg.jpg') }}">
    <div class="container">
        <div class="row">
            <div class="col-lg-5">
        ...
        <div class="row">
            ...
            <div class="col-lg-5 offset-lg-1">
                <div class="home__about__img">
                    <img src="{{ asset('assets/img/about/home-about.jpg') }}" alt="">
                </div>
            </div>
        </div>
    </div>
...
<section class="loan-services spad">
    ...
    <div class="container-fluid">
        <div class="loan__services__list">
            <div class="loan__services__item set-bg" data-setbg="{{ asset('assets/img/loan-services/ls-1.jpg') }}">
            ...
            <div class="loan__services__item set-bg" data-setbg="{{ asset('assets/img/loan-services/ls-2.jpg') }}">
                <div class="loan__services__item__text">
            ...
            <div class="loan__services__item set-bg" data-setbg="{{ asset('assets/img/loan-services/ls-3.jpg') }}">
                <div class="loan__services__item__text">
            ...
            <div class="loan__services__item set-bg" data-setbg="{{ asset('assets/img/loan-services/ls-4.jpg') }}">
                <div class="loan__services__item__text">
            ...
            <div class="loan__services__item set-bg" data-setbg="{{ asset('assets/img/loan-services/ls-5.jpg') }}">
                <div class="loan__services__item__text">
        ...
        <div class="row">
            <div class="col-lg-4 col-md-4 col-sm-6">
                <div class="choose__item">
                    <img src="{{ asset('assets/img/choose/choose-1.png') }}" alt="">
                    <h5>Quick & Easy</h5>
            ...
            <div class="col-lg-4 col-md-4 col-sm-6">
                <div class="choose__item">
                    <img src="{{ asset('assets/img/choose/choose-2.png') }}" alt="">
            ...
            <div class="col-lg-4 col-md-4 col-sm-6">
                <div class="choose__item">
                    <img src="{{ asset('assets/img/choose/choose-3.png') }}" alt="">
            ...
            <div class="col-lg-4 col-md-4 col-sm-6">
                <div class="choose__item">
                    <img src="{{ asset('assets/img/choose/choose-4.png') }}" alt="">
            ...
            <div class="col-lg-4 col-md-4 col-sm-6">
                <div class="choose__item">
                    <img src="{{ asset('assets/img/choose/choose-5.png') }}" alt="">
            ...
            <div class="col-lg-4 col-md-4 col-sm-6">
                <div class="choose__item">
                    <img src="{{ asset('assets/img/choose/choose-6.png') }}" alt="">
...
<div class="testimonial spad set-bg" data-setbg="{{ asset('assets/img/testimonial/testimonial-bg.jpg') }}">
    <div class="container">
        <div class="row">
            <div class="col-lg-12">
                <div class="section-title">
    ...
    <div class="container">
        <div class="row">
            <div class="testimonial__slider owl-carousel">
                ...
                <div class="col-lg-4">
                    <div class="testimonial__item">
                        <img src="{{ asset('assets/img/testimonial/testimonial-3.png') }}" alt="">
        ...
        <div class="row">
            <div class="col-lg-3 col-md-3 col-sm-6">
                <div class="counter__item">
                    <img src="{{ asset('assets/img/counter/counter-1.png') }}" alt="">
            ...
            <div class="col-lg-3 col-md-3 col-sm-6">
                <div class="counter__item">
                    <img src="{{ asset('assets/img/counter/counter-2.png') }}" alt="">
                    <div class="counter__number">
            ...
            <div class="col-lg-3 col-md-3 col-sm-6">
                <div class="counter__item">
                    <img src="{{ asset('assets/img/counter/counter-3.png') }}" alt="">
                    <div class="counter__number">
            ...
            <div class="col-lg-3 col-md-3 col-sm-6">
                <div class="counter__item">
                    <img src="{{ asset('assets/img/counter/counter-4.png') }}" alt="">
                    <div class="counter__number">
...
<!-- Call Section Begin -->
<section class="call spad set-bg" data-setbg="{{ asset('assets/img/call-bg.jpg') }}">
    <div class="container">
        <div class="row">
        ...
        <div class="row">
                ...
                <div class="latest__blog__item">
                    ...
                    <div class="latest__blog__author">
                        <div class="latest__blog__author__pic">
                            <img src="{{ asset('assets/img/latest/lb-1.png') }}" alt="">
                        </div>
            ...
            <div class="col-lg-4 col-md-4 col-sm-6">
                <div class="latest__blog__item">
                    ...
                    <div class="latest__blog__author">
                        <div class="latest__blog__author__pic">
                            <img src="{{ asset('assets/img/latest/lb-2.png') }}" alt="">
                        </div>
                        <div class="latest__blog__author__text">
                            <h6>May Cain</h6>
                            <span>19th March, 2019</span>
            ...
            <div class="col-lg-4 col-md-4 col-sm-6">
                <div class="latest__blog__item">
                    ...
                    <div class="latest__blog__author">
                        <div class="latest__blog__author__pic">
                            <img src="{{ asset('assets/img/latest/lb-3.png') }}" alt="">
                        </div>
                        <div class="latest__blog__author__text">
                            <h6>May Cain</h6>
                            <span>19th March, 2019</span>
...
<!-- Contact Begin -->
<div class="contact-widget set-bg" data-setbg="{{ asset('assets/img/contact-widget.jpg') }}">
    <div class="container">
        <div class="row">
            <div class="col-lg-6 col-md-6">
                <div class="row">
