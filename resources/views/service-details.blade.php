...
<div class="breadcrumb-option set-bg" data-setbg="{{ asset('assets/img/breadcrumb/service-details-breadcrumb.jpg') }}">
    <div class="container">
        <div class="row">
                ...
                <div class="services__details__img">
                    <div class="row">
                        <div class="col-lg-6 col-md-6 col-sm-6">
                            <img src="{{ asset('assets/img/services/details/sd-1.jpg') }}" alt="">
                        </div>
                        <div class="col-lg-6 col-md-6 col-sm-6">
                            <img src="{{ asset('assets/img/services/details/sd-2.jpg') }}" alt="">
                        </div>
                    </div>
                </div>
