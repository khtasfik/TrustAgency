...
<section class="blog-hero set-bg" data-setbg="{{ asset('assets/img/blog/details/details-hero.jpg') }}">
    <div class="container">
        <div class="row">
...
<section class="blog-details spad">
    ...
    <div class="blog__details__slider owl-carousel">
        <div class="blog__details__slider__img set-bg" data-setbg="{{ asset('assets/img/blog/details/slider/slider-1.jpg') }}"></div>
        <div class="blog__details__slider__img set-bg" data-setbg="{{ asset('assets/img/blog/details/slider/slider-1.jpg') }}"></div>
    </div>
    <div class="container">
        <div class="row d-flex justify-content-center">
